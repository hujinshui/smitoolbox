function [ha, Ja] = glinregr1(X, y, w)
...
%       
%       It outputs ha and Ja, which are used to update h and J
%       respectively for a Gaussian prior distribution.
%
%       Formally, the formulas to compute ha and Ja are given as
%       follows:
%
%           ha = sum_i w_i * (y_i * x_i);
%           Ja = sum_i w_i * (x_i * x_i');
%
