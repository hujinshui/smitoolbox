...
namespace boost
{
	...
	/************************************************************
	/* 
	/*   The graph traits and property maps for CRefEdgeList
	/*
	/************************************************************/
	...
	{    
		...
		typedef smi::edge_index_dmap type;
	};
	...
	/************************************************************
	/* 
	/*   The graph traits and property maps for CRefAdjList
	/*
	/************************************************************/
	...
	template<typename TWeight, typename TDirected>
	struct property_map<smi::CRefAdjList<TWeight, TDirected>, boost::vertex_index_t>
	{    
		typedef smi::vertex_index_dmap const_type;
		typedef smi::vertex_index_dmap type;
	};
	...
	template<typename TWeight, typename TDirected>
	struct property_map<smi::CRefAdjList<TWeight, TDirected>, boost::edge_index_t>
	{    
		typedef smi::edge_index_dmap const_type;
		typedef smi::edge_index_dmap type;
	};
	...
	template<typename TWeight, typename TDirected>
	struct property_map<smi::CRefAdjList<TWeight, TDirected>, boost::edge_weight_t>
	{    
		typedef smi::EdgeCRefMap<TWeight> const_type;
		typedef smi::EdgeRefMap<TWeight> type;
	};
